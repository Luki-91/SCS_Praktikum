...
setwd("C:/Users/lukas/Documents/CQ_Praktikum/Spleen_reclustered/CD4+")
...
Idents(SO.har) <- SO.har@meta.data$RNA_snn_res.0.6
SO.har <- RenameIdents(SO.har, '0'='Tcm', '1'='CD69+ Treg', '2'='Itgb1 Tcm',
                       '3'='Th-17 like', '4'='Tfr', '5'='Dapl1+ Tcm',
                       '6'='Contamination','7'='Nkg7+','8'='CXCR6+ Trm',
                       '9'='Apoptotic cells','10'='???',
                       '11'='Type I IFN','12'='Mki67+')
...
SaveSeuratRds(SO.har, file = "./SO.Spleen.CD4+.RDS")
